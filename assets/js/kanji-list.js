document.addEventListener('DOMContentLoaded', () => {
    ...
    if (searchInput && clearBtn) {
        const filterItems = () => {
            ...
            const items = kanjiListContainer.querySelectorAll('.kanji-item');
            ...
            items.forEach(item => {
                ...
                const readings = item.querySelectorAll('.kanji-reading');
                readings.forEach(r => {
                    if (r.textContent.toLowerCase().includes(query)) match = true;
                });
